...
class MainWindow(QMainWindow):
    """
    The main application window for the DOXBEAN simulated DoS tool.
    Provides an enhanced user interface with more visual feedback and controls.
    """
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DOXBEAN by Mojszli")
        ...
        self.credit_label = QLabel("by Mojszli")
